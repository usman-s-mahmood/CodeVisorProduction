            ...
            if 'thumbnail_url' in request.FILES:
                ...
                upload_response = imagekit.upload_file(
                    ...
                    options=UploadFileRequestOptions(
                        folder='/codevisor/blog_thumbnails/'
                    )
                )
...
def contact_view(request):
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            try:
                send_mail(
                    subject=f"Contact Form submission at Madina Traders {subject}",
            ...
            if email_query:
                ...
                try:
                    full_message = f"Dear User,\n\n" \
                        ...
                        f"Best Regards,\n\n" \
                        f"IT Team, Madina Traders"
                    send_mail(
                        subject=f'Newsletter Subscription at Madina Traders',
                        message=full_message,
